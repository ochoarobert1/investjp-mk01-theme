...
<head>
    ...
    <title>Invest JP - <?php _e('Nuevo mensaje de Contacto', 'investjp'); ?></title> <!--   The title tag shows in email notifications, like Android 4.4. -->
...
<![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            <?php _e('Nuevo mensaje de Contacto de:', 'investjp'); ?> {contact_name} - {contact_email}
        </div>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;  margin-bottom: 4em;">
                ...
                <tr>
                    <td style="padding: 40px 0; text-align: center">
                        <img src="{logo}" width="220" height="81" alt="Invest JP" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                    </td>
                </tr>
                <!-- Email Header : END -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style=" text-align: center; margin: 0 0 10px 0; font-size: 25px; line-height: 30px; color: #333333; font-weight: bold;"><?php _e('Nuevo mensaje de Contacto', 'investjp'); ?>.</h1>
                                    <hr>
                                    <h3><?php _e('Nombre completo', 'investjp'); ?>:</h3>
                                    <p style="margin: 0;">{contact_name}</p>

                                    <h3><?php _e('Correo Electrónico', 'investjp'); ?>:</h3>
                                    <p style="margin: 0;">{contact_email}</p>

                                    <h3><?php _e('Número Telefónico', 'investjp'); ?>: </h3>
                                    <p style="margin: 0;">{contact_phone}</p>

                                    <h3><?php _e('Mensaje', 'investjp'); ?>: </h3>
                                    <p style="margin: 0;">{contact_comments}</p>
                                </td>
                            </tr>
                        </table>
                    </td>
