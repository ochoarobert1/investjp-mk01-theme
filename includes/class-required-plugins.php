<?php
add_action( 'tgmpa_register', 'investjp_register_required_plugins' );
 ...
 */
function investjp_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'investjp_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
