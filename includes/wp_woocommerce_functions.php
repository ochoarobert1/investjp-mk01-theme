...
add_action( 'after_setup_theme', 'investjp_woocommerce_support' );
function investjp_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'investjp_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'investjp_woocommerce_custom_wrapper_end', 10);

function investjp_woocommerce_custom_wrapper_start() {
...
function investjp_woocommerce_custom_wrapper_end() {
